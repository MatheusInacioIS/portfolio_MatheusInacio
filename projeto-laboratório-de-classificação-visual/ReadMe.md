...
🔧 Como Executar
Capture ou reúna fotos de tênis (neste projeto, foram utilizados 40 exemplares).
Separe as imagens em classes específicas: "Original" e "Fake".
Realize o upload para a ferramenta Teachable Machine.
Treine o modelo e utilize a função "Preview" para testar a classificação via webcam ou novos arquivos.
